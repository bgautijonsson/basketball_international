...
d <- read_csv(
  ...
  mutate(
    ...
    team1_home = case_when(
      (division == 1) & (season == 2025) & (date < clock::date_build(2025, 8, 25)) ~ 1,
      (division == 1) & (season == 2022) & (date < clock::date_build(2022, 9, 1)) ~ 1,
      (division == 1) & (season == 2017) & (date < clock::date_build(2017, 8, 31)) ~ 1,
      (division == 3) & (season == 2023) & (date < clock::date_build(2023, 8, 25)) ~ 1,
      (division == 3) & (season == 2019) & (date < clock::date_build(2019, 8, 31)) ~ 1,
      TRUE ~ team1_home      
    )
  )
